    ...
    return [
        {
            ...
            purchase: '/workspace/stock-market/purchase-wse-account.worker.ts'
        },
        {
            name: 'TIX API',
            isPurchased: ns.stock.hasTIXAPIAccess, 
            cost: ns.stock.getConstants().TIXAPICost, 
            purchase: '/workspace/stock-market/purchase-tix-api.worker.ts'
        },
        {
            name: '4S data',
            isPurchased: ns.stock.has4SData, 
            cost: ns.stock.getConstants().MarketData4SCost, 
            purchase: '/workspace/stock-market/purchase-4s-market-data.worker.ts'
        },
        {
            name: '4S data TIX API',
            isPurchased: ns.stock.has4SDataTIXAPI, 
            cost: ns.stock.getConstants().MarketDataTixApi4SCost, 
            purchase: '/workspace/stock-market/purchase-4s-market-data-tix-api.worker.ts'
        }
    ]
