...
export async function main(ns: NS) {
    ...
    const contracts = getCurrentContracts(ns, servers).filter(contract => ns.codingcontract.getContractType(contract.filepath, contract.hostname) !== ns.enums.CodingContractName.FindAllValidMathExpressions);
